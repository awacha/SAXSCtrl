...
class MotorDriver(ToolDialog):
    ...
    def __init__(self, credo, motorname, title=None):
        ...
        hb.set_hexpand(True)
        img = Gtk.Image.new_from_icon_name('dialog-warning', size=Gtk.IconSize.DIALOG)
        ...
        hb.pack_start(Gtk.Image.new_from_icon_name('dialog-warning', size=Gtk.IconSize.MENU), False, False, 3)
